...
public class Add_Termination_option_to_existing_lease_Option2 extends BaseClass {
	
	String testCaseName="Add_Termination_option_to_existing_lease_Option2";
	...
	@Test(dataProvider="getData",description = "Add Termination Option to existing lease Option2")
	public void AddTerminationOptiontoexistingleaseOption2(Hashtable<String,String> data,Method method) throws InterruptedException, IOException{
		...
		try {
			...
			testStatus=NewLease_OptionsAndClausePg.ExerciseOptions("Termination");
			if(testStatus){
				BaseClass.reportTestCaseStatus(driver, logger, method.getName(), testStatus);
			...
			TririgaHomePage.NavigateToOptionsAvailableIn30daysPg();
			OptionsAvailableIn30Dayspg.ExceriseOptionFromOptionsAvailableIn30DaysPg("Termination");
			if(testStatus){
				BaseClass.reportTestCaseStatus(driver, logger, method.getName(), testStatus);
				TririgaHomePage.NavigateToHomePg();
			}else{
