...
public class Payment_Adjustment_Adjust_Tax_on_payment_line_items extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Tax_on_payment_line_items";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Tax' on payment line items ";
	...
	public void TaxTypePaymentAdjustment(Hashtable<String, String> data, Method method)
