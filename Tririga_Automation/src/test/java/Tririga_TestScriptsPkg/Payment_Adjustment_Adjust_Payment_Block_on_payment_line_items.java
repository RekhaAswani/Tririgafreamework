...
public class Payment_Adjustment_Adjust_Payment_Block_on_payment_line_items extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Payment_Block_on_payment_line_items";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Payment Block' on payment line items ";
	...
	public void PaymentLinePayment_Block_Type_PaymentAdjustment(Hashtable<String, String> data, Method method)
