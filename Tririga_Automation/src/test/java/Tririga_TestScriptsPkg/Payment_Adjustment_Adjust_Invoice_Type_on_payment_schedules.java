...
public class Payment_Adjustment_Adjust_Invoice_Type_on_payment_schedules extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Invoice_Type_on_payment_schedules";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Invoice Type' on payment schedules ";
	...
	public void InvoiceTypePaymentAdjustment(Hashtable<String, String> data, Method method)
