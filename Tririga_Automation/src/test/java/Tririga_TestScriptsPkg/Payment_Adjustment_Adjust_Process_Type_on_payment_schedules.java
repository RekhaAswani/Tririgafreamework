...
public class Payment_Adjustment_Adjust_Process_Type_on_payment_schedules extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Process_Type_on_payment_schedules";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Process Type' on payment schedules ";
	...
	public void ProcessTypePaymentAdjustment(Hashtable<String, String> data, Method method)
