...
public class Payment_Adjustment_Adjust_Percentage_on_payment_schedules extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Percentage_on_payment_schedules";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Percentage' on payment schedules ";
	...
	public void PercentageTypePaymentAdjustment(Hashtable<String, String> data, Method method)
