...
public class Payment_Adjustment_Adjust_Process_Type_on_payment_line_items extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Process_Type_on_payment_line_items";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Process Type' on payment line items ";
	...
	public void PaymentLineProcessTypePaymentAdjustment(Hashtable<String, String> data, Method method)
