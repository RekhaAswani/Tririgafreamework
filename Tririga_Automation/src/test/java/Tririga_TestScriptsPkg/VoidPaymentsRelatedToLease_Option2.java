...
public class VoidPaymentsRelatedToLease_Option2 extends BaseClass {

	String testCaseName = "VoidPaymentsRelatedToLease_Option2";
	...
	private static final String testCategory = "Void all the unpaid payments related to schedule (Option 2)";
	...
	public void VoidPaymentsRelatedToLeaseOption2(Hashtable<String, String> data, Method method)
		...
		try {
			...
			if (testStatus) {
				...
				PaymentSchedulesPg.clickonVoidBtn();
