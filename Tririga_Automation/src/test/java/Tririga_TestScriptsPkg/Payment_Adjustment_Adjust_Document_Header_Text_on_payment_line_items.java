...
public class Payment_Adjustment_Adjust_Document_Header_Text_on_payment_line_items extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Document_Header_Text_on_payment_line_items";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Document Header' on payment line items ";
	...
	public void PaymentLineDocumentHeaderTypePaymentAdjustment(Hashtable<String, String> data, Method method)
		...
		try {
			...
			if (testStatus) {
				...
				PaymentSchedulesPg.enter_PaymentAdjust_Details("Update Payment Line Items", data);
