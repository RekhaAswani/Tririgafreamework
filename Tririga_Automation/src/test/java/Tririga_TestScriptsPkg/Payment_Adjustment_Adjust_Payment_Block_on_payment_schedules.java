...
public class Payment_Adjustment_Adjust_Payment_Block_on_payment_schedules extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Payment_Block_on_payment_schedules";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Payment Block' on payment schedules  ";
	...
	public void PaymentBlockTypePaymentAdjustment(Hashtable<String, String> data, Method method)
