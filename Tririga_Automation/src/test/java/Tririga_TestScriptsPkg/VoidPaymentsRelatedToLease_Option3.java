...
public class VoidPaymentsRelatedToLease_Option3 extends BaseClass {

	String testCaseName = "VoidPaymentsRelatedToLease_Option3";
	...
	private static final String testCategory = "Void all the unpaid payments related to schedule (Option 3)";
