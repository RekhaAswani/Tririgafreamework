...
public class Payment_Adjustment_Adjust_Percentage_on_payment_line_items extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Percentage_on_payment_line_items";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Percentage' on payment line items ";
	...
	public void PaymentLinePercentageTypePaymentAdjustment(Hashtable<String, String> data, Method method)
