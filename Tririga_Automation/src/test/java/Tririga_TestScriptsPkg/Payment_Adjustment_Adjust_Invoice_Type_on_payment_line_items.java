...
public class Payment_Adjustment_Adjust_Invoice_Type_on_payment_line_items extends BaseClass {

	String testCaseName = "Payment_Adjustment_Adjust_Invoice_Type_on_payment_line_items";
	...
	private static final String testCategory = "Payment Adjustment - Adjust 'Invoice Type' on payment line items ";
	...
	public void PaymentLineInvoiceTypePaymentAdjustment(Hashtable<String, String> data, Method method)
