...
public class Manage_Index_Items extends BaseClass {
	
	String testCaseName="Manage_Index_Items";
	private WebDriver driver = null;
	private ExtentTest logger = null;
	
	public static LoginPage TririgaLoginCls=null;
	public static HomePage TririgaHomePage=null;
	public static ManageIndexItemsPage ManageIndexItemsPg=null;
	...
	private void intialize() {
		...
		ManageIndexItemsPg=new ManageIndexItemsPage(driver,logger);
	...
	@Test(dataProvider="getData",description = "Manage Index Items")
	public void ManageIndexItems(Hashtable<String,String> data,Method method) throws InterruptedException, IOException{
		...
		try {
			...
			if(testStatus){
				...
				TririgaHomePage.NavigateToManageIndexItems();		
			}else{
				BaseClass.reportTestCaseStatus(driver, logger, method.getName(), false);
			}
			
			testStatus=ManageIndexItemsPg.CreateIndexItem(data.get("COSTINDEX"), data.get("INDEXSOURCE"), 
															data.get("BASEINDEX"), data.get("BASEYEAR"));
			if(testStatus){
				BaseClass.reportTestCaseStatus(driver, logger, method.getName(), testStatus);			
			}else{
				BaseClass.reportTestCaseStatus(driver, logger, method.getName(), false);
