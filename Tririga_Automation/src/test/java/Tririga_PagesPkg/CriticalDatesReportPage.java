...
public class CriticalDatesReportPage {
	...
	public String[] ColumnNames={"Contract ID","Primary Loc ID","Primary Location Name",
								"Record Status","Contract Status","Contract Name","Lease Type",
								"Secondary Lease Type","Evergreen","Address","City","Region",
								"Country","Zip/Postal Code","Current Commencement Date",
								"Expiration Date (Current)","Original Commencement Date",
								"Original Expiration Date","Next Expiration Date","Last Expiration Date",
								"Option ID","Option Type","Rolling Option","Conditional","Term",
								"Option Start Date","Option End Date","Last Day Notice",
								"Alert Date","Option Record Status","Currency","Exercise Date",
								"Contact Name","Contact Role"};
		
	public CriticalDatesReportPage(WebDriver driver,ExtentTest logger){
		this.driver=driver;
		this.logger=logger;
		PageFactory.initElements(driver, this);
	}
	
	public boolean VerifyCriticalDatesReportColumnNames() {
