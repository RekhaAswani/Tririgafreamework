...
public class AllIndexClausesPage {
	...
	public String[] ColumnNames={"Contract ID","Contract Name","Contract Status",
								"Portfolio Admin","Property ID","Property Name",
								"Commencement Date","Expiration Date","Clause Name",
								"Cost Index","Index Source","Current Index Value",
								"Index Start Date","Base Year","Index Adjustment Type",
								"Clause Description","Include Partial Adjustments",
								"Adjustment Rule","Adjustment Rule Name","Adjustment Frequency (Months)",
								"Adjustment Effective From","Reference Index From","% Threshold",
								"Threshold Value","Base Index Date","Min % Increase","Max % Increase",
								"% Used"};
		
	public AllIndexClausesPage(WebDriver driver,ExtentTest logger){
		this.driver=driver;
		this.logger=logger;
		PageFactory.initElements(driver, this);
	}
	
	public boolean VerifyIndexReportColumnNames() {
		...
		try{
			...
			WebFrame.switchOnMultipleFramesByXpath(driver, MainFrame);
