...
public class ContractPortfolioOverviewPage {
	...
	public String[] ColumnNames={"!","Contract ID","Contract Name","Lease Type",
								"Business Unit Organization","Primary Location ID","Primary Location Name",
								"Commencement Date","Expiration Date (Current)",
								"Original Expiration Date","Sales Based","Evergreen","Contract Status",
								"Record Status","Description","Expiration Notice",
								"Next Expiration Date","Last Expiration Date",
								"Property Status","Lease Term","Address",
								"Zip/Postal Code","City","State/Province","Country"};
		
	public ContractPortfolioOverviewPage(WebDriver driver,ExtentTest logger){
		this.driver=driver;
		this.logger=logger;
		PageFactory.initElements(driver, this);
	}
	
	public boolean VerifyContractPortfolioOverViewReportColumnNames() {
